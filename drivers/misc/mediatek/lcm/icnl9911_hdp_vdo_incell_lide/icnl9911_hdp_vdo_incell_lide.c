...
//bug654213, liuchunyang.wt, add, 20210517, fix tp no touch for icnl9911 IC
extern unsigned char g_lcm_f6_reg;
...
{0xBE,10,{0x59,0x59,0x50,0x32,0x0C,0x77,0x43,0x07,0x0E,0x0E}},
{0xC0,9,{0x10,0xFF,0xFF,0xFF,0xFF,0xFF,0x00,0xFF,0x00}},
{0xC1,19,{0xC0,0x0C,0x20,0x7C,0x04,0x32,0x32,0x04,0x2A,0x40,0x36,0x00,0x07,0xCF,0xFF,0xFF,0x99,0x01,0xC0}},
{0xC2,1,{0x00}},
...
static struct LCM_setting_table init_setting_vdo2[] = {
{0xFA,3,{0x45,0x93,0x01}},
{0xC7,22,{0xF7,0xB3,0x8E,0x72,0x45,0x26,0xF7,0x4E,0x1E,0xF7,0xD3,0xA8,0x02,0xD8,0xBA,0x8F,0x75,0x4F,0x1A,0x7E,0xC4,0x00}},
{0xC8,22,{0xF7,0xB3,0x8E,0x72,0x45,0x26,0xF7,0x4E,0x1E,0xF7,0xD3,0xA8,0x02,0xD8,0xBA,0x8F,0x75,0x4F,0x1A,0x7E,0xC4,0x00}},
{0xCB,1,{0x00}},
...
static void lcm_init(void)
{
	...
	pr_info("[LCM kernel] set F6 = 0x%02x.\n", g_lcm_f6_reg);
	dsi_set_cmdq_V22(NULL,0xF6,1,&g_lcm_f6_reg,1);//write F6 reg

	push_table(NULL, init_setting_vdo2, sizeof(init_setting_vdo2) / sizeof(struct LCM_setting_table), 1);
}
