...
//Extb ROG-3873 hehao.wt MOD,20210118, T99652AA1 add shake gesture requirement
#if (defined CONFIG_WT_PROJECT_T99653AA1) || (defined CONFIG_WT_PROJECT_T99651AA2) || (defined CONFIG_WT_PROJECT_T99652AA1)
extern int shake_recv_data(struct data_unit_t *event,void *reserved);
#endif
...
//Extb ROG-3873 hehao.wt MOD,20210118, T99652AA1 add shake gesture requirement
#if (defined CONFIG_WT_PROJECT_T99653AA1) || (defined CONFIG_WT_PROJECT_T99651AA2) || (defined CONFIG_WT_PROJECT_T99652AA1)
    shake_recv_data(event,reserved);
#endif
	return err;
}
