...
#define AF_DRVNAME "T99652_CN3927EAF_DRV"
...
/* ////////////////////////////////////////////////////////////// */
long T99652_CN3927E_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
...
int T99652_CN3927E_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	//+EVT1 ROG-2144 ,liuxiangyin.wt,MODIFY,2021/1/12,fix switch video to photo time is slower than that of contrast camera
...
int T99652_CN3927E_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
...
int T99652_CN3927E_GetFileName(unsigned char *pFileName)
{
