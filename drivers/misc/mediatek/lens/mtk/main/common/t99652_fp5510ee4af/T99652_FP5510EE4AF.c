...
/*
 * T99652_FP5510EE4AF voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "T99652_FP5510EE4AF_DRV"
...
static int initAF(void)
{
	...
	if (*g_pAF_Opened == 1) {
		...
		char puSendCmd5[2] = {(char)(0xF2), (char)(0xF8)};
...
/* ////////////////////////////////////////////////////////////// */
long T99652_FP5510EE4AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int T99652_FP5510EE4AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	//+EVT1 ROG-2144 ,liuxiangyin.wt,MODIFY,2021/1/12,fix switch video to photo time is slower than that of contrast camera
...
int T99652_FP5510EE4AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int T99652_FP5510EE4AF_GetFileName(unsigned char *pFileName)
{
