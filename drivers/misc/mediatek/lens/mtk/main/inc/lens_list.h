...
extern int CN3927E_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				 spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long CN3927E_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int CN3927E_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int CN3927E_GetFileName(unsigned char *pFileName);

#define CN3927E_SetI2Cclient CN3927E_SetI2Cclient_Main
#define CN3927E_Ioctl CN3927E_Ioctl_Main
#define CN3927E_Release CN3927E_Release_Main
#define CN3927E_GetFileName CN3927E_GetFileName_Main
//- bug590447,cdzk,add,20200923,camera af bring up


//+ bug591033,cdzk,add,20201023,camera af bring up
extern int CN3927E_QH_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				 spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long CN3927E_QH_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int CN3927E_QH_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int CN3927E_QH_GetFileName(unsigned char *pFileName);

#define CN3927E_QH_SetI2Cclient CN3927E_QH_SetI2Cclient_Main
#define CN3927E_QH_Ioctl CN3927E_QH_Ioctl_Main
#define CN3927E_QH_Release CN3927E_QH_Release_Main
#define CN3927E_QH_GetFileName CN3927E_QH_GetFileName_Main
//- bug591033,cdzk,add,20201023,camera af bring up

//+bug584789,zhouyikuan.wt,ADD,2020/20/26,CN3927E af bring up
extern int T99652_CN3927E_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
                                 spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long T99652_CN3927E_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
                           unsigned long a_u4Param);
extern int T99652_CN3927E_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int T99652_CN3927E_GetFileName(unsigned char *pFileName);

#define T99652_CN3927E_SetI2Cclient T99652_CN3927E_SetI2Cclient_Main
#define T99652_CN3927E_Ioctl T99652_CN3927E_Ioctl_Main
#define T99652_CN3927E_Release T99652_CN3927E_Release_Main
#define T99652_CN3927E_GetFileName T99652_CN3927E_GetFileName_Main
//-bug584789,zhouyikuan.wt,ADD,2020/20/26,CN3927E af bring up

//+bug584789,zhouyikuan.wt,ADD,2020/20/27,T99652_FP5510EE4AF af bring up
extern int T99652_FP5510EE4AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
                                 spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long T99652_FP5510EE4AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
                           unsigned long a_u4Param);
extern int T99652_FP5510EE4AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int T99652_FP5510EE4AF_GetFileName(unsigned char *pFileName);

#define T99652_FP5510EE4AF_SetI2Cclient T99652_FP5510EE4AF_SetI2Cclient_Main
#define T99652_FP5510EE4AF_Ioctl T99652_FP5510EE4AF_Ioctl_Main
#define T99652_FP5510EE4AF_Release T99652_FP5510EE4AF_Release_Main
#define T99652_FP5510EE4AF_GetFileName T99652_FP5510EE4AF_GetFileName_Main
//-bug584789,zhouyikuan.wt,ADD,2020/20/27,T99652_FP5510EE4AF af bring up
//+bug584789 chenbocheng.wt, add, 2020/10/28, main camera lens fp5516we4 porting
#define FP5516WE4_SetI2Cclient FP5516WE4_SetI2Cclient_Main
#define FP5516WE4_Ioctl FP5516WE4_Ioctl_Main
#define FP5516WE4_Release FP5516WE4_Release_Main
#define FP5516WE4_GetFileName FP5516WE4_GetFileName_Main
extern int FP5516WE4_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
	spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long FP5516WE4_Ioctl(struct file *a_pstFile,
	unsigned int a_u4Command, unsigned long a_u4Param);
extern int FP5516WE4_Release(struct inode *a_pstInode,
	struct file *a_pstFile);
extern int FP5516WE4_GetFileName(unsigned char *pFileName);
//-bug584789 chenbocheng.wt, add, 2020/10/28, main camera lens fp5516we4 porting
//+bug584789 chenbocheng.wt, add, 2020/11/13, main camera lens fp5516we4_st porting
#define FP5516WE4_ST_SetI2Cclient FP5516WE4_ST_SetI2Cclient_Main
#define FP5516WE4_ST_Ioctl FP5516WE4_ST_Ioctl_Main
#define FP5516WE4_ST_Release FP5516WE4_ST_Release_Main
#define FP5516WE4_ST_GetFileName FP5516WE4_ST_GetFileName_Main
extern int FP5516WE4_ST_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
	spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long FP5516WE4_ST_Ioctl(struct file *a_pstFile,
	unsigned int a_u4Command, unsigned long a_u4Param);
extern int FP5516WE4_ST_Release(struct inode *a_pstInode,
	struct file *a_pstFile);
extern int FP5516WE4_ST_GetFileName(unsigned char *pFileName);
//-bug584789 chenbocheng.wt, add, 2020/11/13, main camera lens fp5516we4_st porting
