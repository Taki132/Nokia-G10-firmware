...
#include<linux/hardware_info.h> //Bug589772,liuchunyang.wt,add,20210223, modify TP Hardware information
...
static int cts_init_fwdata(struct cts_device *cts_dev)
{
    ...
    u8  val;
    int ret;
    char ctp_info[HARDWARE_MAX_ITEM_LONGTH]; //Bug589772,liuchunyang.wt,add,20210223, modify TP Hardware information
...
//+Bug589772,liuchunyang.wt,add,20210223, modify TP Hardware information
