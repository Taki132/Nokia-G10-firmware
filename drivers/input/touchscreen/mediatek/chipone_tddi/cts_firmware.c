...
//#include<linux/hardware_info.h> //Bug589772,fangzhihua.wt,add,20201118, add TP Hardware information
...
//+bug621232, liuchunyang.wt, modify, 20210202, compatible 99652/99653 different TP icnl9911 FW 
#if defined(CONFIG_WT_PROJECT_T99652AA1)
    #include "cts_builtin_firmware_t99652aa1.h"//FW version:0x207
#elif defined(CONFIG_WT_PROJECT_T99653AA1)
    #include "cts_builtin_firmware_t99653aa1.h"//FW version:0x207
#else
    #include "cts_builtin_firmware.h"//FW version:0x207
#endif
//-bug621232, liuchunyang.wt, modify, 20210202, compatible 99652/99653 different TP icnl9911 FW
        ...
        const struct cts_firmware *firmware, bool to_flash)
{
    ...
    int ret, retries;
    //char ctp_info[HARDWARE_MAX_ITEM_LONGTH]; //Bug589772,fangzhihua.wt,add,20201118, add TP Hardware information

    cts_info(">>>to_flash:%d", to_flash);
    ...
    cts_info("step4:%d, to_flash:%d", ret, to_flash);
    if (!to_flash) {
        goto out;
    }
...
//+Bug589772,fangzhihua.wt,add,20201118, add TP Hardware information
    //sprintf(ctp_info,"Lide,ICNL9911C,FW:0x%04x\n",FIRMWARE_VERSION(firmware));
    //hardwareinfo_set_prop(HARDWARE_TP,ctp_info);
//-Bug589772,fangzhihua.wt,add,20201118, add TP Hardware information
