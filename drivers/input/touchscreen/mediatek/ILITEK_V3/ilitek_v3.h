...
#define SPI_CLK                         12      /* follow by clk list *///RNN-2249, liuchunyang.wt, MODIFY, 20210113, modify SPI frequency
#define SPI_RETRY			5
...
#define WINGTECH_TP_HARDWARE_INFO 1 //bug566814, sheqihao.wt, ADD, 20200623, Add ilitek-ili9882h tp openshort test
...
enum TP_MODEL {
	...
	MODEL_TXD,
	MODEL_TM,
	MODEL_HX, //bug566814, sheqihao.wt, ADD, 20200623, Add ilitek-ili9882h tp openshort test
	MODEL_SKYWORTH //bug594067, sheqihao.wt, ADD, 20201014, Add ilitek-ili9882h tp openshort test
};
...
/*  add_for_charger_end  */
	...
	bool power_status;
	bool proxmity_face;
	bool mp_result; //bug566814, sheqihao.wt, ADD, 20200623, Add ilitek-ili9882h tp openshort test
