...
//+bug566814, sheqihao.wt, ADD, 20200623, Add ilitek-ili9882h tp openshort test
	int ret = 0;
//+bug594067, sheqihao.wt, ADD, 20201014, Add ilitek-ili9882h tp openshort test
   if (lcm_name == 7 ) {
        ret = MODEL_SKYWORTH;
        }
	else if (lcm_name == 8 ) {
...
//+bug566814, sheqihao.wt, ADD, 20200623, Add ilitek-ili9882h tp openshort test
	case MODEL_HX:
		ilits->md_name = "HX";
		ilits->md_fw_filp_path = HX_FW_FILP_PATH;
		ilits->md_fw_rq_path = HX_FW_REQUEST_PATH;
		ilits->md_ini_path = HX_INI_NAME_PATH;
		ilits->md_ini_rq_path = HX_FW_REQUEST_PATH;
		ilits->md_fw_ili = CTPM_FW_HX;
		ilits->md_fw_ili_size = sizeof(CTPM_FW_HX);
		break;
//-bug566814, sheqihao.wt, ADD, 20200623, Add ilitek-ili9882h tp openshort test
...
//+bug594067, sheqihao.wt, ADD, 20201014, Add ilitek-ili9882h tp openshort test
	case MODEL_SKYWORTH:
		...
		ilits->md_fw_filp_path = SKYWORTH_FW_FILP_PATH;
		ilits->md_fw_rq_path = SKYWORTH_FW_REQUEST_PATH;
		ilits->md_ini_path = SKYWORTH_INI_NAME_PATH;
		ilits->md_ini_rq_path = SKYWORTH_FW_REQUEST_PATH;
		ilits->md_fw_ili = CTPM_FW_SKYWORTH;
		ilits->md_fw_ili_size = sizeof(CTPM_FW_SKYWORTH);
		break;
//-bug594067, sheqihao.wt, ADD, 20201014, Add ilitek-ili9882h tp openshort test
	default:
		break;
