		...
		void *rxbuf, unsigned n_rx)
{
	...
	case SPI_READ:
		...
		break;
	//+bug624386, sheqihao.wt, add, 20210204,  CID164582 fix Function "ili_spi_write_then_read_direct"  dead case
	//default:
	//	ILI_INFO("Unknown command 0x%x\n", cmd);
	//	break;
	//-bug624386, sheqihao.wt, add, 20210204,  CID164582 fix Function "ili_spi_write_then_read_direct"  dead case
...
//+bug624462, sheqihao.wt, add, 20210204,  CID164658 fix Function "ilitek_spi_probe"  dereference null  value
	/*if (!spi) {
