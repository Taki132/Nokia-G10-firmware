...
//+bug585487,wangyongfei_wt,20200917,add,google-key
#ifdef CONFIG_WT_PROJECT_T99621AA3
#include <linux/of_gpio.h>
#define KEY_GOOGLE 249
#endif
//-bug585487,wangyongfei_wt,20200917,add,google-key

//+ WVR-12182, madan,20211203, add, google key bring up
#if !defined CONFIG_WT_PROJECT_T99621AA3 && defined CONFIG_WT_GOOGLE_KEY && defined CONFIG_WT_GOOGLE_KEY_VALUE
#include <linux/of_gpio.h>
#define KEY_GOOGLE CONFIG_WT_GOOGLE_KEY_VALUE
#endif
//- WVR-12182, madan,20211203, add, google key bring up
...
//+bug585487,wangyongfei_wt,20200917,add,google-key
#if defined CONFIG_WT_PROJECT_T99621AA3 || defined CONFIG_WT_GOOGLE_KEY
...
static void kpd_gpio_google_key_hal(unsigned long data)
{
	...
	printk("kpd_gpio_google_key_hal state = %d\n",kpd_gpio_google_key_eint_state);

	input_report_key(keypad->input_dev, KEY_GOOGLE, kpd_gpio_google_key_eint_state);
	input_sync(keypad->input_dev);
...
//+bug585487,wangyongfei_wt,20200917,add,google-key
#if defined CONFIG_WT_PROJECT_T99621AA3 || defined CONFIG_WT_GOOGLE_KEY
	__set_bit(KEY_GOOGLE, keypad->input_dev->keybit);
#endif
//+bug585487,wangyongfei_wt,20200917,add,google-key
