				  ...
				  unsigned int selector)
{
	...
	idx = pvol[selector];
//+chk 67731,lishuwen.wt,2020.10.16,modify vibrator working voltage
//+chk 68993,jinpeng1.wt,2020.10.23,modify vibrator working voltage
#if defined(CONFIG_WT_PROJECT_T99651AA2) || defined(CONFIG_WT_PROJECT_T99621AA3)
	if ((info->desc.vsel_reg == MT6357_VIBR_ANA_CON0) && (info->vsel_shift == MT6357_RG_VIBR_VOSEL_SHIFT) ){
		idx = 12; //PMIC6357 data sheet 11 = 3.0V but the actual 11 = 2.9v 12 = 3.0V
		//printk("lsw_vibrator %s %d name %s vsel_reg = %d vsel_shift = %d idx = %d\n",__func__, __LINE__,info->desc.name,info->desc.vsel_reg,info->vsel_shift,idx);
	}
//+Bug 603434,lishuwen.wt,2020.10.16,[from_hardware disturbance]modify vibrator working voltage to 2.65V
#elif defined(CONFIG_WT_PROJECT_T99652AA1) || defined(CONFIG_WT_PROJECT_T99653AA1)
	if ((info->desc.vsel_reg == MT6357_VIBR_ANA_CON0) && (info->vsel_shift == MT6357_RG_VIBR_VOSEL_SHIFT) ){
		idx = 8; //8 = 2.65V 7 = 2.14V 9 = 2.73V
	}
//-Bug 603434,lishuwen.wt,2020.10.16,[from_hardware disturbance]modify vibrator working voltage to 2.65V
#endif
//-chk 68993,jinpegn1.wt,2020.10.23,modify vibrator working voltage
//-chk 67731,lishuwen.wt,2020.10.16,modify vibrator working voltage
