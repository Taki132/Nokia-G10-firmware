...
//Modify by xu_shengjie@hoperun.com for WVR-12711 setting maximum charge percentage 2022-05-16 begin
#if defined(CONFIG_WT_PROJECT_T99653AA1) || defined(CONFIG_WT_PROJECT_T99652AA1) || defined(CONFIG_WT_PROJECT_T99651AA2)
#include "mtk_charger.h"
#endif
//Modify by xu_shengjie@hoperun.com for WVR-12711 setting maximum charge percentage 2022-05-16 end
//+bug 585485,jinpeng1.wt,2020.9.28,modify,get battery id in factory mode
//bug 589756, yaocankun, mod, 20201010, for charger bringup
#if defined(CONFIG_WT_PROJECT_T99621AA3) || defined(CONFIG_WT_PROJECT_T99653AA1) || defined(CONFIG_WT_PROJECT_T99651AA2) || defined(CONFIG_WT_PROJECT_T99652AA1)
#include <linux/iio/consumer.h>
#include <linux/hardware_info.h>
#endif
//-bug 585485,jinpeng1.wt,2020.9.28,modify,get battery id in factory mode
#if defined(CONFIG_WT_PROJECT_T99621AA3)
extern bool check_hl7057(void); //bug 585485, jinpeng1,20201110,modify, porting code for chargeIC  HL7057 battery capacity
extern int bq2415x_get_charger_status(void); //BUG IRM-18093,jinpeng1.wt,2020.12.15,modify,improve power_supply node customization
#elif defined(CONFIG_WT_PROJECT_T99651AA2)
extern int bq2415x_get_charger_status(void); //extb WVR-10442,lishuwen.wt,2021.01.07,modify,improve power_supply node customization to call notify_fg_chg_full
#endif
//Modify by xu_shengjie@hoperun.com for WVR-12711 setting maximum charge percentage 2022-05-16 begin
...
//+bug 585485,jinpeng1.wt,2020.9.28,modify,get battery id in factory mode
//bug 589756, yaocankun, mod, 20201010, for charger bringup
//+bug 591035,lishuwen.wt,2020.10.13,modify,get batt_id_ohms in factory mode
#define BATTERY_ID_PULL_UP		200000	//Ohms
#define BATTERY_ID_REFER_VOLT		1800	//mV

#if defined(CONFIG_WT_PROJECT_T99621AA3) || defined(CONFIG_WT_PROJECT_T99653AA1) || defined(CONFIG_WT_PROJECT_T99651AA2) || defined(CONFIG_WT_PROJECT_T99652AA1)
int fgauge_get_profile_id_T99621AA3(struct platform_device *pdev, int *batt_id_ohms )
//-bug 591035,lishuwen.wt,2020.10.13,modify,get batt_id_ohms in factory mode
{
	...
	{
		ret = PTR_ERR(channel);
		bm_err("channel auxadc get fail, ret=%d\n", ret);
		return TOTAL_BATTERY_NUMBER - 1;
	}
	ret = iio_read_channel_processed(channel,&auxadc_voltage);
	if(ret < 0)
	{
		bm_err("get battery id voltage failed\n");
		return TOTAL_BATTERY_NUMBER - 1;
	}
	//id_volt = auxadc_voltage * 1500/4096;
	id_volt = auxadc_voltage * 1000; //mV turn to uV
	printk("auxadc_voltage = %d ,id_volt = %d\n",auxadc_voltage,id_volt);
	for (id = 0; id < TOTAL_BATTERY_NUMBER; id++)
	{
		...
		{
			id = TOTAL_BATTERY_NUMBER - 1;
		}
	}
//+bug 585485,jinpeng1.wt,2020.11.17,modify,fix batteri id bug
...
//-bug 585485,jinpeng1.wt,2020.11.17,modify,fix batteri id bug
//+bug 591035,lishuwen.wt,2020.10.13,modify,get batt_id_ohms in factory mode
	*batt_id_ohms = ((id_volt /1000) * BATTERY_ID_PULL_UP)
					/ (BATTERY_ID_REFER_VOLT - (id_volt /1000)  );
	printk("battery id =%d batt_id_ohms = %d\n",id ,*batt_id_ohms);
//-bug 591035,lishuwen.wt,2020.10.13,modify,get batt_id_ohms in factory mode
	return id;
}
#endif
	...
	union power_supply_propval *val)
{
	...
	case POWER_SUPPLY_PROP_CAPACITY:
		...
		/* 6= ATE_factory_boot */
//+bug 584789, lishuwen, delete, 20201103, for meta mode display the true capacity
/*
...
//-bug 584789, lishuwen, delete, 20201103, for meta mode display the true capacity
	...
	case POWER_SUPPLY_PROP_CURRENT_NOW:
                //+ Bug585485, jinpeng1@WT, 20200917,modify, change current direction 
//bug 589756, yaocankun, mod, 20201010, for charger bringup
//extb RNN-4319, lishuwen, mod, 20210202, modify change current direction for VTS test failed
		...
		val->intval =
			...
			* 100;
#endif
                //- Bug585485, jinpeng1@WT, 20200917,modiify, change current direction 
		break;
...
//+bug 591035,lishuwen.wt,2020.10.13,modify,get batt_id_ohms in factory mode
	case POWER_SUPPLY_PROP_RESISTANCE_ID:
		val->intval = bs_data->batt_id_ohms;
		break;
//-bug 591035,lishuwen.wt,2020.10.13,modify,get batt_id_ohms in factory mode
...
//+BUG IRM-18093,jinpeng1.wt,2020.12.15,modify,improve power_supply node customization to call notify_fg_chg_full
#if defined(CONFIG_WT_PROJECT_T99621AA3) || defined(CONFIG_WT_PROJECT_T99651AA2)
		status.intval = bq2415x_get_charger_status();
...
int BattThermistorConverTemp(struct mtk_battery *gm, int Res)
{
	...
	if (Res >= ptable[0].TemperatureR) {
		TBatt_Value = -400;
//+Bug 604976,lishuwen.wt,2020.12.18,modify,battery temp shutdown threthold to 62
#if defined(CONFIG_WT_PROJECT_T99653AA1) || defined(CONFIG_WT_PROJECT_T99651AA2) || defined(CONFIG_WT_PROJECT_T99652AA1)
...
//+bug 585485,jinpeng1.wt,2020.9.28,modify factoy mode battery test
//bug 589756, yaocankun, mod, 20201010, for charger bringup
#if defined(CONFIG_WT_PROJECT_T99621AA3) || defined(CONFIG_WT_PROJECT_T99653AA1) || defined(CONFIG_WT_PROJECT_T99651AA2) || defined(CONFIG_WT_PROJECT_T99652AA1)
void battery_setprop(const char *battery_name)
{
	if(battery_name == NULL) {
		hardwareinfo_set_prop(HARDWARE_BATTERY_ID, "BATTERY_UNKNOW");
	} else {
...
//bug 589756, yaocankun, mod, 20201010, for charger bringup
	...
	gm->battery_id = fgauge_get_profile_id_T99621AA3(dev, &gm->bs_data.batt_id_ohms);
#else
...
//+bug 585485,jinpeng1.wt,2020.11.17,modify,fix batteri id bug
		if(battery_name == NULL) {
			...
			//bat_id = BATTERY_PROFILE_ID;
		}
//-bug 585485,jinpeng1.wt,2020.11.17,modify,fix batteri id bug
        printk("battery_name = %s",battery_name);
    }
#endif
//-bug 585485,jinpeng1.wt,2020.9.28,modify,get battery id in factory mode
	fg_cust_data = &gm->fg_cust_data;
	...
	bm_err("disable_nafg:%d\n",
		fg_cust_data->disable_nafg);
//+bug IRM-18366,jinpeng1.wt,2020.11.4,modify,mtk patch to battery cell
#if defined(CONFIG_WT_PROJECT_T99621AA3) || defined(CONFIG_WT_PROJECT_T99653AA1) || defined(CONFIG_WT_PROJECT_T99651AA2) || defined(CONFIG_WT_PROJECT_T99652AA1)
	bm_err("%s not fg_swocv_v fg_swocv_i shutdown_time \n", __func__);
#else
...
//+bug 585485, jinpeng1,20201110,modify, porting code for chargeIC  HL7057 battery capacity
#if defined(CONFIG_WT_PROJECT_T99621AA3)
    if (check_hl7057()) {
        bm_err("the charger IC is hl7057\n");
        fg_read_dts_val(np, "g_FG_PSEUDO100_T0_hl7057",
            &(fg_table_cust_data->fg_profile[0].pseudo100),
            UNIT_TRANS_100);
        fg_read_dts_val(np, "g_FG_PSEUDO100_T1_hl7057",
            &(fg_table_cust_data->fg_profile[1].pseudo100),
            UNIT_TRANS_100);
        fg_read_dts_val(np, "g_FG_PSEUDO100_T2_hl7057",
            &(fg_table_cust_data->fg_profile[2].pseudo100),
            UNIT_TRANS_100);
        fg_read_dts_val(np, "g_FG_PSEUDO100_T3_hl7057",
            &(fg_table_cust_data->fg_profile[3].pseudo100),
            UNIT_TRANS_100);
        fg_read_dts_val(np, "g_FG_PSEUDO100_T4_hl7057",
            &(fg_table_cust_data->fg_profile[4].pseudo100),
            UNIT_TRANS_100);
    }
#endif
//-bug 585485, jinpeng1,20201110,modify, porting code for chargeIC  HL7057 battery capacity
//+ bug 584789, lishuwen,20210918,modify, modify for chargeIC  battery capacity
#if defined(CONFIG_WT_PROJECT_T99653AA1) || defined(CONFIG_WT_PROJECT_T99652AA1)
...
//Modify by xu_shengjie@hoperun.com for WVR-12711 setting maximum charge percentage 2022-05-16 begin
#if defined(CONFIG_WT_PROJECT_T99653AA1) || defined(CONFIG_WT_PROJECT_T99652AA1) || defined(CONFIG_WT_PROJECT_T99651AA2)
static int hmd_battery_info_update(struct mtk_battery *gm)
{
	struct battery_data *bs_data;
	struct power_supply *chg_psy = NULL;
	union power_supply_propval online, status;
	...
	if (!IS_ERR_OR_NULL(chg_psy)){
		...
		if (!online.intval)
			...
			/*else{
				...
				if(ret != 0){
					status.intval = bq2415x_get_charger_status();
					pr_info("%s(%d): bq2415x_get_charger_status status.intval=%d\n", __func__, __LINE__, status.intval);
				}
				#endif

				#if defined(CONFIG_WT_PROJECT_T99653AA1) || defined(CONFIG_WT_PROJECT_T99652AA1)
				if(ret != 0){
					status.intval = bq2560x_get_charger_status();	
					pr_info("%s(%d): bq2560x_get_charger_status status.intval=%d\n", __func__, __LINE__, status.intval);
				}
				#endif
			}*/
			...
			if (status.intval == POWER_SUPPLY_STATUS_NOT_CHARGING)
				...
				bs_data->bat_status =
					POWER_SUPPLY_STATUS_CHARGING;
			pr_info("%s(%d): bs_data->bat_status=%d\n", __func__, __LINE__, bs_data->bat_status);
		}
	}
	return 0;
}

int hmd_maximum_charge_percentage_check(struct mtk_battery *gm)
{
	struct mtk_charger *info;
	struct power_supply *chg_psy = power_supply_get_by_name("mtk-master-charger");
	
	//Add by xu_shengjie@hoperun.com to fix system panic after factory reset 2022-05-26 begin
	if(chg_psy == NULL){
		pr_info("%s(%d): get mtk-master-charger fail\n", __func__, __LINE__);
		return -1;
	}
	
	info = (struct mtk_charger *)power_supply_get_drvdata(chg_psy);
	if(chg_psy == NULL){
		pr_info("%s(%d): get mtk_charger fail\n", __func__, __LINE__);
		return -2;
	}
	//Add by xu_shengjie@hoperun.com to fix system panic after factory reset 2022-05-26 end
	
	if((gm->ui_soc >= gm->hmd_bat_max_charge_percentage) 
		&& (gm->hmd_bat_max_charge_percentage < 100)) {
		
		if(gm->force_stop_charge == false){
			pr_info("%s(%d): _mtk_force_stop_charge_func true\n", __func__, __LINE__);
			_mtk_force_stop_charge_func(info, true);
			gm->force_stop_charge = true;
			hmd_battery_info_update(gm);
		}
	}else{
		if(gm->force_stop_charge == true){
			pr_info("%s(%d): _mtk_force_stop_charge_func false\n", __func__, __LINE__);
			_mtk_force_stop_charge_func(info, false);
			gm->force_stop_charge = false;
...
void battery_update(struct mtk_battery *gm)
{
	...
	//Modify by xu_shengjie@hoperun.com for WVR-12711 setting maximum charge percentage 2022-05-16 begin
	#if defined(CONFIG_WT_PROJECT_T99653AA1) || defined(CONFIG_WT_PROJECT_T99652AA1) || defined(CONFIG_WT_PROJECT_T99651AA2)
	hmd_maximum_charge_percentage_check(gm);
	#endif
	//Modify by xu_shengjie@hoperun.com for WVR-12711 setting maximum charge percentage 2022-05-16 end
...
//+bug 589756, yaocankun, add, 20201105, add chargring node
#ifdef WT_COMPILE_FACTORY_VERSION
#if defined(CONFIG_WT_PROJECT_T99653AA1) || defined(CONFIG_WT_PROJECT_T99652AA1) || defined(CONFIG_WT_PROJECT_T99621AA3)
#include "mtk_charger.h"
...
static int StartCharging_Test_get(struct mtk_battery *gm,
	...
	int *val)
{
//+Bug 605310,lishuwen.wt,2020.12.03,modify,modify charger current nod status
	struct battery_data *bs_data;
	struct mtk_charger *info;
	struct power_supply *chg_psy = power_supply_get_by_name("mtk-master-charger");
...
#if defined(CONFIG_WT_PROJECT_T99653AA1) || defined(CONFIG_WT_PROJECT_T99652AA1)
	info->disable_charging_test = 0;
	_wake_up_charger(info);
	pr_err("lsw enable cmd charging %d bat_status:%d\n",info->disable_charging_test,bs_data->bat_status);
#else
...
//+Bug 597174,lishuwen.wt,2020.11.06,modify,add charger current nod
#if defined(CONFIG_WT_PROJECT_T99653AA1) || defined(CONFIG_WT_PROJECT_T99652AA1)
	info->wt_chg_sw_term = 0;
	info->disable_charging_test = 1;
	_wake_up_charger(info);
	pr_err("lsw enable cmd discharging %d bat_status:%d\n",info->disable_charging_test,bs_data->bat_status);
#else
	if(!info->cmd_discharging)
	{
...
//Modify by xu_shengjie@hoperun.com for WVR-12711 setting maximum charge percentage 2022-05-12 begin
#if defined(CONFIG_WT_PROJECT_T99653AA1) || defined(CONFIG_WT_PROJECT_T99652AA1) || defined(CONFIG_WT_PROJECT_T99651AA2)
static int hmd_battery_max_charge_percentage_get(struct mtk_battery *gm,
	struct mtk_battery_sysfs_field_info *attr,
	int *val)
{
	*val = gm->hmd_bat_max_charge_percentage;
	pr_info("%s: hmd_bat_max_charge_percentage=%d\n", __func__, *val);
	return 0;
}

static int hmd_battery_max_charge_percentage_set(struct mtk_battery *gm,
	struct mtk_battery_sysfs_field_info *attr,
	int val)
{
	if (val >= 100)
		...
		gm->hmd_bat_max_charge_percentage = 30;
	else
		gm->hmd_bat_max_charge_percentage = val;
	
	pr_info("%s: set hmd_bat_max_charge_percentage=%d\n", __func__, gm->hmd_bat_max_charge_percentage);
	battery_update(gm);
	return 0;
}
#endif
...
#if defined(CONFIG_WT_PROJECT_T99653AA1) || defined(CONFIG_WT_PROJECT_T99652AA1) || defined(CONFIG_WT_PROJECT_T99651AA2)
extern int set_jeita_phone_call(bool onoff);
extern int get_jeita_phone_call(void);
static int jeita_phone_call_get(struct mtk_battery *gm,
	struct mtk_battery_sysfs_field_info *attr,
	int *val)
{
	*val = get_jeita_phone_call();
	//pr_err("lsw_jeita %s %d\n", __func__, *val);
	return 0;
}

static int jeita_phone_call_set(struct mtk_battery *gm,
	struct mtk_battery_sysfs_field_info *attr,
	int val)
{
	set_jeita_phone_call(val);
	//pr_err("%s %d\n", __func__, val);
	return 0;
}
#endif
...
//+bug 589756, yaocankun, add, 20201105, add chargring node
//+bug chk69046, jinpeng1, add, 20201105, add chargring node
#ifdef WT_COMPILE_FACTORY_VERSION
#if defined(CONFIG_WT_PROJECT_T99653AA1) || defined(CONFIG_WT_PROJECT_T99652AA1) || defined(CONFIG_WT_PROJECT_T99621AA3)
	BAT_SYSFS_FIELD_RW(StartCharging_Test, BAT_PROP_LOG_START_CHARGING),
	BAT_SYSFS_FIELD_RW(StopCharging_Test, BAT_PROP_LOG_STOP_CHARGING),
#endif
#endif
//-bug chk69046, jinpeng1, add, 20201105, add chargring node
//-bug 589756, yaocankun, add, 20201105, add chargring node
//+chk 69775,lishuwen.wt,2020.12.02,jeita for current limit
#if defined(CONFIG_WT_PROJECT_T99653AA1) || defined(CONFIG_WT_PROJECT_T99652AA1) || defined(CONFIG_WT_PROJECT_T99651AA2)
	BAT_SYSFS_FIELD_RW(jeita_phone_call, BAT_PROP_JEITA_PHONE_CALL),
#endif
//-chk 69775,lishuwen.wt,2020.12.02,jeita for current limit
//Modify by xu_shengjie@hoperun.com for WVR-12711 setting maximum charge percentage 2022-05-16 begin
#if defined(CONFIG_WT_PROJECT_T99653AA1) || defined(CONFIG_WT_PROJECT_T99652AA1) || defined(CONFIG_WT_PROJECT_T99651AA2)
	BAT_SYSFS_FIELD_RW(hmd_battery_max_charge_percentage, BAT_PROP_HMD_MAX_CHARGE_PERCENTAGE),
#endif
//Modify by xu_shengjie@hoperun.com for WVR-12711 setting maximum charge percentage 2022-05-16 end
...
//+Extb RNN-2164,liaojiaxin.wt,add,20201205,get the boot mode
extern int boot_mode_check;
