...
//+bug chk69046, jinpeng1, add, 20201105, add chargring node
	...
	BAT_PROP_LOG_START_CHARGING,
	BAT_PROP_LOG_STOP_CHARGING,
#endif
//-bug chk69046, jinpeng1, add, 20201105, add chargring node
//-bug 589756, yaocankun, add, 20201105, add chargring node
//+chk 69775,lishuwen.wt,2020.12.02,jeita for current limit
	...
	BAT_PROP_JEITA_PHONE_CALL,
#endif
//-chk 69775,lishuwen.wt,2020.12.02,jeita for current limit
//Modify by xu_shengjie@hoperun.com for RNN-6713 setting maximum charge percentage 2022-05-16 begin
#if defined(CONFIG_WT_PROJECT_T99653AA1) || defined(CONFIG_WT_PROJECT_T99652AA1) || defined(CONFIG_WT_PROJECT_T99651AA2)
	BAT_PROP_HMD_MAX_CHARGE_PERCENTAGE,
#endif
//Modify by xu_shengjie@hoperun.com for RNN-6713 setting maximum charge percentage 2022-05-16 end
};
...
//bug 589756, yaocankun, mod, 20201015, mod bat shutdown temp
...
#define BATTERY_SHUTDOWN_TEMPERATURE 62
//-Bug 604976,lishuwen.wt,2020.12.18,modify,battery temp shutdown threthold to 62
#endif
...
/*battery full*/
	...
	int hmd_bat_max_charge_percentage;
	#endif
